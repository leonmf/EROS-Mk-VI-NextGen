/*
  IOBox_M7_stage12_m4_status_only.ino
...
void setup()
{
  ...
  Serial.println();
  Serial.println("M7: stage12 M4-status-only display starting");
  Serial.println("M7: no display startup until M4_READY_FOR_RPC and loopback pass");
  Serial.println("M7: uses stable Command4 transport; display indicators update only from M4-reported masks");
}
