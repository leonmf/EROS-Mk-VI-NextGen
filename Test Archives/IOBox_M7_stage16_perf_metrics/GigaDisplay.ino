...
static void GigaDisplay_CreateStatusScreen()
{
  ...
  g_statusDebugValueLabels[20] = GigaDisplay_CreateStatusDebugRow(20, "M7 status poll avg ms");
  g_statusDebugValueLabels[21] = GigaDisplay_CreateStatusDebugRow(21, "M7 status polls");
...
static void GigaDisplay_CreateAutoSettingsScreen()
{
  ...
  // Stage 13: disable LVGL touch scrolling on this screen.
  // Scrolling here has caused Mbed SOS crashes on the Giga Display.
  // A later revision should split Auto Settings into pages instead of using scroll.
