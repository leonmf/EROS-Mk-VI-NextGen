/*
 * IOBox_M4_stage18_screen_guards.ino
 *
...
void setup()
{
  ...
  SerialRPC.begin();
  SerialRPC.println("M4: IOBox_M4 stage16 perf-metrics starting");
  ...
  SerialRPC.println("M4: IOBox_M4 stage16 perf-metrics setup complete");
#endif
}
