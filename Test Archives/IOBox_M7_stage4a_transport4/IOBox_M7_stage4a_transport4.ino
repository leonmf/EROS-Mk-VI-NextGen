/*
  IOBox_M7_stage4a_transport4.ino
...
void setup()
{
  ...
  Serial.println();
  Serial.println("M7: stage 4A EROS transport4 loopback test starting");
  Serial.println("M7: uses 4-argument EROS_M4_Command4 instead of 5-argument command");
