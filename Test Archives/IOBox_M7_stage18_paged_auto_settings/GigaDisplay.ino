...
static void GigaDisplay_CreateAutoSettingsScreen()
{
  // Stage 18: use fixed pages instead of a scrollable LVGL screen.
  // The previous scrollable Auto Settings screen could still trigger SOS
  // after repeated scrolling even with refresh guards. Paging avoids active
  // scroll mechanics and keeps the number of live LVGL objects smaller.
