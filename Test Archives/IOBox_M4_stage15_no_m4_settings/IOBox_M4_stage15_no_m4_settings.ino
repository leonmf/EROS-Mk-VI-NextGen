/*
 * IOBox_M4_stage15_no_m4_settings.ino
 *
...
void setup()
{
  ...
  SerialRPC.begin();
  SerialRPC.println("M4: IOBox_M4 stage11 status-masks starting");
  ...
  SerialRPC.println("M4: IOBox_M4 stage11 status-masks setup complete");
#endif
}
