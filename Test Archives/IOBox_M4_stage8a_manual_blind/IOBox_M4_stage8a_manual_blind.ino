/*
 * IOBox_M4_stage6_skip_settings.ino
 *
...
void setup()
{
  ...
  SerialRPC.begin();
  SerialRPC.println("M4: IOBox_M4 stage8A manual-blind using stage6 stable M4 starting");
  ...
  SerialRPC.println("M4: IOBox_M4 stage8A setup complete");
#endif
}
