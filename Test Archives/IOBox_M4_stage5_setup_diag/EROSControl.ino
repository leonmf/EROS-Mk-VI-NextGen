...
void Control_Setup(void)
{
  ...
  SerialRPC.println("M4_DIAG: before Settings_Begin");
  Settings_Begin();
  SerialRPC.println("M4_DIAG: after Settings_Begin");

  // Load settings from flash memory
  SerialRPC.println("M4_DIAG: before Settings_LoadAllOrDefaults");
  Settings_LoadAllOrDefaults();
  SerialRPC.println("M4_DIAG: after Settings_LoadAllOrDefaults");
