...
// UI-side transport entry point.
// Today this calls the in-process transport shim. Later it becomes the
...
{
  // Split-core architecture: M7 owns persistent settings.
  // Do not send save requests to M4. M7 storage implementation comes next.
}

void Command_RequestSettingsLoad()
{
  // Split-core architecture: M7 owns persistent settings.
  // Do not send load requests to M4. M7 storage implementation comes next.
}
...
unsigned long State_GetM4LoopCounter()
{
  return g_m7ControlStatus.m4LoopCounter;
}

unsigned int State_GetM4AvgLoopPeriodUs()
{
  return g_m7ControlStatus.m4AvgLoopPeriodUs;
}

unsigned int State_GetM4AvgLoopExecUs()
{
  return g_m7ControlStatus.m4AvgLoopExecUs;
}

unsigned long State_GetM7StatusPollCounter()
{
  return g_m7ControlStatus.m7StatusPollCounter;
}

unsigned int State_GetM7StatusPollAvgMsX100()
{
  return g_m7ControlStatus.m7StatusPollAvgMsX100;
}
